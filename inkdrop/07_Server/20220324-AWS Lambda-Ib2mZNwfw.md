...
[コンソールで Lambda の関数の作成 - AWS Lambda](https://docs.aws.amazon.com/ja_jp/lambda/latest/dg/getting-started-create-function.html)

Pythonだけでなく、Node.jsでもできるみたい
[Lambda プログラミングモデル - AWS Lambda](https://docs.aws.amazon.com/ja_jp/lambda/latest/dg/foundation-progmodel.html)
